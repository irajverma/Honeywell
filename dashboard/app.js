        ...
        document.getElementById('alerts-tbody').innerHTML = `
            <tr>
                <td colspan="7" style="text-align:center; padding:30px; color:#ff3366;">
                    ⚠️ Error Loading Telemetry Feed: Ensure local web server is running from repository root (e.g., 'python -m http.server 8000') and access via http://localhost:8000/dashboard/
                </td>
            </tr>
        `;
    }
